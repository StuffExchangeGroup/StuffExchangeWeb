...
@Component({
    selector: 'app-product-image-slide',
    templateUrl: './product-image-slide.component.html',
    styleUrls: ['./product-image-slide.component.scss']
})
export class ProductImageSlideComponent implements OnInit {
